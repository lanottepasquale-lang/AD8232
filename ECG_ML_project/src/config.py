...
P_MIN_AMPLITUDE_FRACTION = 0.04    # soglia minima per considerare valido un candidato P
...
# --- Canale TCP con ecg_realtime.py (collega) ---
# Il suo script apre un socket CLIENT verso questi HOST/PORTA_OUT (vedi
# AD8232/ecg_realtime.py) e ci manda batch JSON di campioni GIA' filtrati
# (Butterworth 0.5-40Hz applicato da lui). Devono combinare esattamente.
